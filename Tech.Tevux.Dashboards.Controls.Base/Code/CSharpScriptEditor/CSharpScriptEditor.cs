...
public partial class CSharpScriptEditor : Control, IDisposable {
    ...
    static CSharpScriptEditor() {
        DefaultStyleKeyProperty.OverrideMetadata(typeof(CSharpScriptEditor), new FrameworkPropertyMetadata(typeof(CSharpScriptEditor)));
    }
    ...
    public CSharpScriptEditor(CSharpScriptControlBase control) {
        ...
        var scriptBinding = new Binding(nameof(CSharpScriptControlBase.Script)) { Source = _scriptButton, Mode = BindingMode.TwoWay };
